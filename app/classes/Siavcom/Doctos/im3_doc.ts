...
// @baseClass  : Component
// @class : im3_doc
// Description : Componente im3_doc
...
export class im3_doc extends CAPTURECOMPONENT {
    //public
    constructor() {
        super();
        this.prop.Type = 'number';
        this.prop.ControlSource = "vi_cap_comedoc.im3_doc";
    ...
    public override init() {
        super.init();
        this.prop.Caption = (Public.value.di3_pge);
