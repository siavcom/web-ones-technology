...
export class mes_pry extends CAPTURECOMPONENT {
  /**
   * Class mes_pry.
   * @memberof mes_pry
   * @description Mensaje del estatus
  ...
  constructor() {
    ...
    this.prop.Caption = "Mensaje del estatus";
    this.prop.Type = "textArea";
    this.prop.BaseClass = "editText";
    this.prop.ControlSource = "vi_cap_comepry.mes_pry";
    this.prop.Placeholder = "OBSERVACION DEL PROYECTO";
    this.prop.ToolTipText = "OBSERVACION DEL PROYECTO";

    this.prop.Capture = true;
    this.prop.updateKey = false;

    this.inputStyle.width = "800px";
