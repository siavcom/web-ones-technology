...
// @baseClass  : COLUMN
// @class : json_tap
// Description : Datos que contiene la actividad
...
export class json_tap extends COLUMN {
  constructor() {
    super();

    // const nom_ind=renglon[i]['nom_ind']

    this.prop.ColumnTextLabel = "Datos json"; // Column Header
    this.prop.Type = "text";
    this.prop.Type = "textArea";
    this.prop.ControlSource = "vi_cap_cometap.json_tap";
    this.prop.Placeholder = "Datos json";
