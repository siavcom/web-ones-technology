...
// @baseClass  : COLUMN
// @class : usa_tap
// Description : Usuarios que puede autorizar
...
export class usa_tap extends COLUMN {
  constructor() {
    super();

    // const nom_ind=renglon[i]['nom_ind']

    this.prop.ColumnTextLabel = "Usuarios que puede autorizar"; // Column Header
    this.prop.Type = "text";
    this.prop.BaseClass = "editText";
    this.prop.ControlSource = "vi_cap_cometap.usa_tap";
    this.prop.Placeholder = "Usuarios que puede autorizar,Bloquear,Cancelar";
