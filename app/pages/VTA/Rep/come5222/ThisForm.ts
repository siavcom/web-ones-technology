...
export class ThisForm extends reportInv {
  ...
  constructor() {
    ...
    this.prop.Name = 'come5222'
    this.prop.Caption = "Insumos por sucursal"
    this.prop.Status = 'A'
    this.prop.Development = true
    this.vis_rep = 'vi_come5203'   // nombre de la vista sql a utilizar en el reporte
    this.for_imp.prop.Value = 'jr_come5222'   // no incluir extencion jasper o jrxml
    ...
    this.in_tdo_tdo.prop.MultiSelect = false
 ...
 SELECT 
   ...
   SUM(PVE_MOV) AS pve_mov INTO  #RESULTADO from ${this.vis_rep} ${con_vis}
