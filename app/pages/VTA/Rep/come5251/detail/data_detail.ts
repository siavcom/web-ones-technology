...
export class data_detail extends CONTAINER {
  ...
  async open(transporte: string) {
    ...
    this.Form.block[1].prop.Visible = true; // Mostrar el bloque de entrada de datos
    ...
    //  this.Form.block[0].prop.Visible = true
  }

  async close() {
    this.prop.Visible = false
    this.Form.block[1].prop.Visible = false; // Mostrar el bloque de entrada de datos
