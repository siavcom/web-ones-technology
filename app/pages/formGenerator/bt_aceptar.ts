...
export class bt_aceptar extends IMGBUTTON {
  ...
  override async click() {
    ...
    if (
      ...
      console.log(
        "bt_aceptar this.Form.grid_form.elements",
        this.Form.grid_form.elements
      );
      for (let i = 0; i < this.Form.grid_form.elements.length; i++) {
        const comp = this.Form.grid_form.elements[i].Name;
        this.Form.grid_form[comp].prop.ControlSource =
          "vi_cap_form." + comp.toLowerCase();
        console.log(
          "bt_aceptar elements",
          comp,
          this.Form.grid_form[comp].prop.ControlSource
    ...
    if (
      ...
      for (let i = 0; i < this.Form.grid_columns.elements.length; i++) {
        ...
        this.Form.grid_columns[comp].prop.ControlSource =
          "vi_cap_grid." + comp.toLowerCase();
        console.log(
          "bt_aceptar elements",
          comp,
          this.Form.grid_form[comp].prop.ControlSource
