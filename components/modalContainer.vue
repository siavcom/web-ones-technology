<template>
  <Teleport to="body">
    <Transition name="modal">
      <div class="modal-mask" v-if="This.prop.Visible">
        <div class="modal-container" :style="This.style">
            ...
            <slot name="componentes">
              <div v-if="Divi" v-for="(Ver) in  Divi" :key="Ver">
                <div v-for=" (Ele) in  Ver" :key="Ele" style="padding-bottom:2px">
                  <component :is="impComp(Ele.prop.BaseClass)" v-bind:Component="ref(Ele)"
                    v-model:Value="Ele.prop.Value" v-model:Status="Ele.prop.Status" v-model:Focus="Ele.Focus"
