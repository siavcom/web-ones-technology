          ...
          <div v-for="(compHeader) in This.header">
            ...
            <div v-for="(compMain) in This.main" :key="compMain" style="z-index:0">
              <component :is="impComp(This[compMain].prop.BaseClass)" v-bind:Component="ref(This[compMain])"
                ...
                v-bind:position="This[compMain].position" v-bind:db="ref(This.db)"
    ...
    -->
          ...
          <div v-show="This.prop.Status != 'A'">
            ...
            <div v-for="(compFooter) in This.footer" style="zIndex:0">
              ...
              <component :is="impComp(This[compFooter].prop.BaseClass)" 
                v-bind:Component="ref(This[compFooter])"
                v-model:Value="This[compFooter].prop.Value" 
                v-model:Status="This[compFooter].prop.Status"
                v-model:ShowError="This[compFooter].prop.ShowError" 
                ...
                This[compFooter].Recno" v-bind:prop="This[compFooter].prop"
                v-bind:style="This[compFooter].style" v-bind:position="This[compFooter].position"
                v-bind:db="ref(This.db)" @focusout="This.eventos.push('This.' + compFooter + '.valid()')"
