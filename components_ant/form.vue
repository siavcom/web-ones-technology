...
const impComp = ((name: string,pos:string) => {
  if (pos=='header')
  console.log('Form impComp header ',name,ThisForm.header)
  if (pos=='main')
  console.log('Form impComp main ',name,ThisForm.header)
  if (pos=='footer')
  console.log('Form impComp footer ',name,ThisForm.header)
