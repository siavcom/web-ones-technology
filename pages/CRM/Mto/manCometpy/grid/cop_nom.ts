...
export class cop_nom extends COLUMN {
    ...
    constructor() {
       ...
       // const nom_ind=renglon[i]['nom_ind']
        ...
        this.textLabel = 'Cliente/Proveedor' // Column Header
        this.prop.Type ='text'
        this.prop.BaseClass = 'comboBox'
        this.prop.ControlSource = 'vi_cap_cometpy.cop_nom'
        this.prop.Placeholder = 'CLIENTE/PROVEEDOR'
        this.prop.ToolTipText ='CLIENTE/PROVEEDOR'
        ...
        this.prop.RowSource=[['Clientes','Proveedores'],['C','P'] ]      // 
