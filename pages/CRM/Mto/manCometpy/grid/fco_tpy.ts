...
export class fco_tpy extends COLUMN {
    ...
    constructor() {
       ...
       // const nom_ind=renglon[i]['nom_ind']
        ...
        this.textLabel = 'FORMATO DE IMPRESION DE LA COTIZACION' // Column Header
        this.prop.Type ='text'
        this.prop.BaseClass = 'editText'
        this.prop.ControlSource = 'vi_cap_cometpy.fco_tpy'
        this.prop.Placeholder = 'FORMATO DE IMPRESION DE LA COTIZACION'
        this.prop.ToolTipText ='FORMATO DE IMPRESION DE LA COTIZACION'
