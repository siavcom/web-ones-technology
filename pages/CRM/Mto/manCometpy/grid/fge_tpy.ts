...
export class fge_tpy extends COLUMN {
    ...
    constructor() {
       ...
       // const nom_ind=renglon[i]['nom_ind']
        ...
        this.textLabel = 'FORMATO DE IMPRESION DEL GENERADOR' // Column Header
        this.prop.Type ='text'
        this.prop.BaseClass = 'editText'
        this.prop.ControlSource = 'vi_cap_cometpy.fge_tpy'
        this.prop.Placeholder = 'FORMATO DE IMPRESION DEL GENERADOR'
        this.prop.ToolTipText ='FORMATO DE IMPRESION DEL GENERADOR'
