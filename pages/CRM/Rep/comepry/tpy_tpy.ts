...
export class tpy_tpy extends COMPONENT {
  constructor() {
    ...
    this.prop.textLabel = "Tipo de proyectos";
  ...
  async interactiveChange() {
    if (this.prop.Value != "?? ") {
      ...
      this.Parent.est_tap.prop.Disabled = false;
      this.Parent.tap_tap.prop.Disabled = false;
      this.Parent.des_fac.prop.Visible = true;
      this.Parent.has_fac.prop.Visible = true;
      this.Parent.est_tap.prop.Visible = true;
      this.Parent.tap_tap.prop.Visible = true;
      this.Parent.tap_tap.prop.RowSource = ` select des_tap,tap_tap from man_cometap where tpy_tpy = '${this.prop.Value}' union select '  Todos ' as des_tap,'?? ' as tap_tap order by des_tap `;
    } else {
      this.Parent.des_fac.prop.Disabled = true;
      this.Parent.has_fac.prop.Disabled = true;
      this.Parent.est_tap.prop.Disabled = true;
      this.Parent.tap_tap.prop.Disabled = true;
      this.Parent.des_fac.prop.Visible = false;
      this.Parent.has_fac.prop.Visible = false;
      this.Parent.est_tap.prop.Visible = false;
      this.Parent.tap_tap.prop.Visible = false;

      this.Parent.tap_tap.prop.RowSource = ` select '  Todos ' as des_tap,'?? ' as tap_tap order by des_tap `;
    }
    return;
  }
} //
